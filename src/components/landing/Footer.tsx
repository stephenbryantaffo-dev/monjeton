      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid sm:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[#79847E]">
              <li><a href="#demo" className="hover:text-[#7CFF3A] transition-colors">{lt.footer_features}</a></li>
              <li><a href="#pricing" className="hover:text-[#7CFF3A] transition-colors">{lt.footer_pricing}</a></li>
              <li><a href="#faq" className="hover:text-[#7CFF3A] transition-colors">{lt.footer_faq}</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <a href="/privacy" className="text-xs text-[#79847E] hover:text-[#7CFF3A] transition-colors">{lt.footer_privacy}</a>
            <a href="/terms" className="text-xs text-[#79847E] hover:text-[#7CFF3A] transition-colors">{lt.footer_terms}</a>
          </div>
        </div>
      </div>
    </footer>
